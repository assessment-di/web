          ...
          <GridColumn span="10/12">
            <Box background="white" borderRadius="large" padding={6}>
              ...
              <Box marginTop={6}>
                ...
                <Text marginBottom={4}>
                  Member of Althingi for the Reykjavik North Constituency
                  2016–2021 and the Reykjavik North Constituency since 2021
                  (Independence Party).
                </Text>
                <Text variant="h4" as="h3" marginBottom={2}>
                  Title
                </Text>
                <Text variant="h5" as="h4" marginBottom={2}>
                  Committees
                </Text>
                <Text marginBottom={1}>
                  <b>Present committees</b>
                </Text>
                ...
                <Text marginTop={3} marginBottom={1}>
                  <b>Previous committees</b>
                </Text>
                <ul style={{ marginTop: 0 }}>
                  <li>
                    Member of the Foreign Affairs Committee 2017–2019 (Chair
                    2017–2019).
                  </li>
                  <li>
                    Member of the Icelandic delegation to the
                    Inter-Parliamentary Union (IPU) 2017–2019 (Chair 2017–2019).
                  </li>
                  <li>
                  ...
                  <li>
                    Member of the Icelandic delegation to the NATO Parliamentary
                    Assembly 2017 (Chair 2017)
                  </li>
                  <li>
                    Member of the Icelandic delegation to the
                  ...
                  <li>
                    Member of the EU-Iceland joint Parliamentary Committee
                    2018–2019 (Chair 2018–2019).
                  </li>
                </ul>
                <Text variant="h5" as="h4" marginTop={4} marginBottom={2}>
                  Ministerial career
                </Text>
                <ul style={{ marginTop: 0 }}>
                  <li>
